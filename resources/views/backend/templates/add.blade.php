...
@section('title', 'Admin - New Template')
...
@section('content')
    ...
    <!-- Basic Layout -->
    <form action="{{ route('admin.templates.add') }}" id="identifier" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-control" id="" onchange="showSubCategory(this.value)">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sub_category" class="form-control" id="sub_category" onchange="showSubSubcategory(this.value)">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" id="" class="form-control" name="format" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="">Serials List</label>
                            <textarea name="stock_list" class="form-control p-1" placeholder="1, 2, 3, 4 ..." id="" rows="5" style="width: 100%"></textarea>
                        </div>
                        <div class="mb-3">
                          <label class="form-check-label" for="manual">Account</label>
                          <input type="checkbox" id="" name="check_box_value" value="1">
                      </div>
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="dynamic-fields-container">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="checkbox" id="manual" name="private" value="1">
                      </div>
                    </div>
                </div>
