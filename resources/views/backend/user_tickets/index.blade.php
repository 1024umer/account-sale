...
@section('title', 'Admin - User Tickets')
    ...
    <script>
        (function() { // webpackBootstrap
            ...
            $('#main-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.usertickets.list') !!}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
            ...
            $(document).on('click', '.details-btn', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "".concat(baseUrl, "admin/usertickets/details/").concat(user_id),
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: "".concat(baseUrl, "admin/usertickets/delete/").concat(user_id),
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <small>Total User Tickets</small>
                        </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('admin.usertickets.answer') }}" method="POST">
                    @csrf
