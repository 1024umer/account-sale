    ...
    <script>
        (function() { // webpackBootstrap
            ...
            $('#main-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.subcategories.list') !!}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
            ...
            $(document).on('click', '.edit-btn', function() {
                $('#addNewUserForm').attr('action', `{{ route('admin.subcategories.update') }}`);
                $('#id').val($(this).data('id'));
            ...
            $(document).on('click', '.addBtn', function() {
                $('#name').val('');
                $('#addNewUserForm').attr('action', `{{ route('admin.subcategories.add') }}`);
            });
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: "".concat(baseUrl, "admin/subcategories/delete/").concat(user_id),
    ...
    <div class="card">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            ...
            <div class="offcanvas-body mx-0 flex-grow-0">
                <form action="{{ route('admin.subcategories.add') }}" method="post" class="add-new-user pt-0" id="addNewUserForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" id="id" value="">
                    <div class="mb-3">
                        <label class="form-label" for="add-user-fullname">Category</label>
                        <select type="text" class="form-control" value="{{ old('name') }}" id="category_id" name="category_id" aria-label="John Doe">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ old('name') }}" id="name" placeholder="SubCategory name"
