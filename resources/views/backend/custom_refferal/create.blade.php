...
@section('title', 'Admin - Create Custom Refferal')
    ...
    <script>
      $(document).ready(function () {
          $('#basic-default-fullname1').on('input', function () {
              ...
              var dynamicIP = window.location.host;
              var referralLink = 'http://' + dynamicIP + '/?ref=' + referralName;
...
@section('content')
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <form id="identifier" action="{{ route('admin.customrefferal.refferal.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
