...
<section class="service  pb-90" data-bg-img="assets/img/media/service-bg.png">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{ route('profile.purchses') }}" style="color: white;">
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ url('signup/'.$user->username) }}</p>
                        <!-- Add more product details as needed -->
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">$ {{ 'User Balance: '.$user->balance.'$' }}</p>
                        <!-- Add more product details as needed -->
                        <button class="btn btn-large btn-primary" id="openModalBtn">Add Balance</button>
                                ...
                                <div class="table-body">
                                    ...
                                    <div class="table-row p-3 my-3">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <p>
                                                <div class="order-status {{ $order->status == 'success' ? 'success' : 'pending' }}">
                                                    {{ $order->status }}
                                                </div>
                                                </p>
                                            </div>
