            ...
            <div class="col-lg-7">
                <div class="banner-content">
                    ...
                    <!-- <div class="banner-btn-group">
                            <div class="btn-wrap"><span></span> <a href="#" class="btn btn-white">GET IT
                                    NOW</a></div><a href="https://www.youtube.com/watch?v=ni5hRK1ehzk"
                                class="mfp-iframe video-btn"><i class="fa fa-play"></i> PLAY
                                INTRO</a>
                        </div> -->
                </div>
            </div>
                ...
                <div class="contact-form-wrap">
                    ...
                    <form action="https://themelooks.net/demo/dvpn/html/preview/sendmail.php" class="contact-form">
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" id="minimun" placeholder="$0" value="" type="number">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" id="maximum" placeholder="$1,0000" value="" type="number">
                                </div>
                            </div>
