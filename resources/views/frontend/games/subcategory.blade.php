            ...
            <section class="popular-section mt-5 py-5">
                <div class="container pb-5">
                    ...
                    <div class="products-side my-5">
                        <div class="row">
                            <h3 class="w-100 mx-auto fw-bold mt-3">
                                <img style="width: 30px;" src="{{ $subCategory->image }}">
                        ...
                        <div class="row text-center bg-light rounded">
                            ...
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/subcategory/'.$slug.'/atoz') }}">Name A to Z</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/subcategory/'.$slug.'/ztoa') }}">Name Z to A</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/subcategory/'.$slug.'/cheaper') }}">Cheaper</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/subcategory/'.$slug.'/expensive') }}">Expensive</a>
                            </div>
                        </div>
                        <div class="row row-cols-">
                            <div class="row">
                            @foreach($gamingAccounts as $product)
                                    ...
                                    <div class="game-card shadow-lg">
                                        ...
                                        <div class="card-content" style="width: 40%;display: flex;justify-content: center;">
                                            <p class="d-inline-block m-0">
                                                ...
                                                <span class="text-center d-inline-block p-2 my-1" style="background-color: #20ada3; border-radius: 5%;color: black;">{{ $product->discount }}% OFF</span>
                                                @endif
                                                <span class="text-center d-inline-block p-2 my-1" style="background-color: lightgrey; border-radius: 5%;">{{ $product->emailChannels()->where('status', 'available')->count() }} PCs</span>
                                                <span class="text-center d-inline-block p-2 my-1" style="background-color: lightgrey; border-radius: 5%;">Price: 
                                                    @if ($product->discount > 0)
                                                    <span style="text-decoration: line-through;">{{ $product->price }}$ </span>
                                                    @endif
                                                    {{ $product->price - ($product->price * $product->discount / 100) }}$
                                                </span>
                                                <a style="box-shadow: 8px 12px 20px 4px lightblue;border: 0px;font-weight: 600;font-size: 13px;line-height: 26px;" class="text-center d-inline-block btn btn-info p-2 my-1 mb-2" href="{{ route('games.details', ['slug' => $product->title]) }}">Buy Now</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
