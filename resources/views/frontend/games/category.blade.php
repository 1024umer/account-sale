                    ...
                    <div class="products-side my-5">
                        <div class="row text-center bg-light rounded">
                            ...
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/category/'.$slug.'/atoz') }}">Name A to Z</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/category/'.$slug.'/ztoa') }}">Name Z to A</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/category/'.$slug.'/cheaper') }}">Cheaper</a>
                            </div>
                            <div class="col-md-2 col-6 align-self-center">
                                <a class="m-2 d-inline-block" href="{{ url('games/category/'.$slug.'/expensive') }}">Expensive</a>
                            </div>
                        </div>
