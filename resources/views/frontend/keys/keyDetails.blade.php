...
@section('content')
        ...
        <div class="page-head">
            <div class="container">
                <div class=" container-heading breadcrumb">
                    ...
                    <a href="{{ route('licence.keys') }}">licence keys > </a>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('stripe.pay') }}" class="require-validation"
                ...
                <input type="hidden" required name="product_type" value="LicenceKey">
                            ...
                            <div class="col-md-6 left-side p-4">
                                ...
                                <div class="bottom p-2">
                                    <div class="d-flex my-3 align-items-center justify-content-between">
                                        ...
                                        <h1>$<span class="totalPrice">{{ $product->keyChannels[0]->price }}</span>
                            ...
                            <div class="col-md-6 right p-4">
                                <div class="top p-2">
                                    ...
                                    <div class="icons-div my-4">
                                        ...
                                        <div class="icons py-icons my-2 p-4 me-3" data-value="paypal">
                                            <img src="{{ asset('frontend/images/paypal.svg') }}" alt="">
                                        </div>
                                        @endif
                                        @if($data->stripe_secret)
                                        <div class="icons py-icons my-2 bg-border p-4" data-value="stripe">
                                            <img src="{{ asset('frontend/images/stripe.png') }}" alt="">
                                        </div>
                                        @endif
                                        @if($data->coinbase_api_key)
                                        <div class="icons py-icons my-2 p-4" data-value="coinbase">
