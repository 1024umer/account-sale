...
@if ($data)
    @section('meta_title', $data->meta_title . ' Sign In')
                    ...
                    <div class="card-body">
                        <form action="{{ route('signin.check') }}" method="post">
                            ...
                            <div class="my-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="form-check">
                                        <input class="form-check-input" name="remember_token" type="checkbox" value="" id="flexCheckDefault">
                            ...
                            <div class="my-4 signup">
                                <p>Don't have a personal account? <a href="{{ route('signup') }}">Sign it up</a></p>
                            </div>
                        </form>
                    </div>
                </div>
