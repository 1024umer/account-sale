...
@section('content')
                ...
                <div class="row my-4">
                    <div class="col-md-8">
                        <div class="left-side row p-4">
                            <div class="col-md-3 main-img-cont pe-3">
                                <img class="main-img h-100" src="{{ $product->medias[0]->image }}" alt="product image">
                            </div>
                            <div class="col-md-9">
                                <div class="top">
                                    ...
                                    <div class="icons-div my-4 py-0 d-flex align-items-center overflow-auto">
                                        ...
                                        <div class="icon">
                                            <img src="{{ asset('frontend/images/dots-circle.png') }}" alt="icon">
                                            <p>misc</p>
                                        </div>
                                        <div class="icon">
                                            <img src="{{ asset('frontend/images/aim.png') }}" alt="icon">
                                        ...
                                        <div class="icon">
                                            <img src="{{ asset('frontend/images/colors.png') }}" alt="icon">
                                            <p>colors</p>
                                        </div>
                                        <div class="icon">
                                            <img src="{{ asset('frontend/images/settings.png') }}" alt="icon">
                                            <p>settings</p>
                                        </div>
                                        <div class="icon">
                                            <img src="{{ asset('frontend/images/skins.png') }}" alt="icon">
                    ...
                    <div class="col-md-4 right-side p-4">
                        <div class="product-rate w-100">
                            <div class="top">
                                <div class="region">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_932_5370" maskUnits="userSpaceOnUse" x="0" y="0"
                                            width="25" height="24" style="mask-type:alpha">
                                            <circle cx="12.5" cy="12" r="12" fill="#C4C4C4"></circle>
                                        </mask>
                                        <g mask="url(#mask0_932_5370)">
                                            <mask id="mask1_932_5370" maskUnits="userSpaceOnUse" x="-4"
                                                y="0" width="33" height="24" style="mask-type:alpha">
                            ...
                            @if ($productType == 'LicenceKey')
                                <div class="bottom p-4 pt-5 pb-2">
                                    @foreach ($product->keyChannels as $channel)
                                        <div class="rates p-2 {{ $loop->index == '0' ? 'add-background' : '' }} mb-3">
                                            <div class="rate  p-2 d-flex align-items-center justify-content-between">
                                                <div class="rate-left d-flex align-items-center">
                                                    ...
                                                    <p class="mb-0 ml-2 ms-1">{{ $channel->days }} Days</p>
                                                </div>
                                                <div class="right-side">
                                                    <h4 class="m-auto">${{ $channel->price }}<p>.00</p>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bottom p-4 pt-5 pb-2">
                                    <div class="rates p-2 add-background mb-3">
                                        <div class="rate  p-2 d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="right-side">
                                                <h4 class="m-auto">${{ $product->price }}<p>.00</p>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="pay-div p-4 pt-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <p>To pay:</p>
                                    @if ($productType == 'LicenceKey')
                                        <h4 class="total-p">$<span
                                                class="totalPrice">{{ $product->keyChannels[0]->price }}</span>
                                            <p>.00</p>
                                        </h4>
                                    @else
                                        <h4 class="total-p">$<span class="totalPrice">{{ $product->price }}</span>
                                            <p>.00</p>
                                        </h4>
                                    @endif
                                </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('pay') }}" class="require-validation"
                ...
                <input type="hidden" required name="product_type" value="{{ $productType }}">
                <input type="hidden" required name="quantity" id="quantity_input" value="1">
                <input type="hidden" required name="payment_method" id="payment_method" value="stripe">
                @if ($productType == 'LicenceKey')
                    <input type="hidden" required class="totalPriceInput" name="days"
                        value="{{ $product->keyChannels[0]->days }}">
                @else
                    <input type="hidden" required class="totalPriceInput" name="totalPrice"
                        value="{{ $product->price }}">
                @endif
                            ...
                            <div class="col-md-6 left-side p-4">
                                ...
                                <div class="bottom p-2">
                                    <div class="d-flex my-3 align-items-center justify-content-between">
                                        ...
                                        <h1>$<span
                                                class="totalPrice">{{ $productType == 'GamingAccount' ? $product->price : $product->keyChannels[0]->price }}</span>
